        ...
        <body>
            ...
            <form role="search" class="header-form">
                ...
                <c:if test="${not empty user }">
                    <c:if test="${role==2}"><a class="btn-header" style="cursor: pointer"
                       href="<c:url value="/user/info.do"/>">${user.name}</a></c:if>
                    <c:if test="${role==1}"><a class="btn-header" style="cursor: pointer"
                       href="<c:url value="/food/foodPage.do"/>">${user.name}</a></c:if>
