                ...
                <div class="card-body">
                    ...
                    <form action="<c:url value="/user/checkRegister.do"/>">
                        ...
                        <div class=" mb-3">
                            ...
                            <input class="form-control" type="text" name="name" id="email" value="${name}" required="" >

                        </div>
                        <div class=" mb-3">
                            <label for="email">Email:</label>
                            <input class="form-control" type="email" name="email" id="email" value="${email}" required="" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">

                        </div>
                        <div class=" mb-3">
                            <label for="phone">Phone Number:</label>
                            <input class="form-control" type="text" name="phone" id="phone" value="${phone}" required="" pattern="^0\d{9}$">
                            ${accountEmail}
