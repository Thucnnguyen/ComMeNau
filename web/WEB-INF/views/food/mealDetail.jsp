...
<html>
    <head>
        ...
        <link href="${pageContext.request.contextPath}/css/mealDetail.css" rel="stylesheet" type="text/css"/>
        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div>
                    ...
                    <div class="row">
                        <c:if test="${empty mealList}"><h1>Khung giờ này đã hết mâm cơm. Mong quý khách thông cảm</h1></c:if>
