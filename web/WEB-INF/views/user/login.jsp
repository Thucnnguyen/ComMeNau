...
<html>
    ...
    <body>
       ...
       <div class="d-flex align-items-center justify-content-center login-card">
            <div class="card login-container">
                <div class="card-header text-center login-title">Login Form</div>
                <div class="message"> ${information}</div>
                <div class="card-body">
                    <form action="<c:url value="/user/checkLogin.do"/>" method="post">
